...
from energize.networks.torch.callbacks import ModelCheckpointCallback, TimedStoppingCallback
...
class Test(unittest.TestCase):
    ...
    def test_time_stop(self):
        ...
        trainer = Trainer(None, None, None, None, None, None,
                          None, None, callbacks=[callback_to_test])
    ...
    def test_model_saving(self):
        ...
        optimiser = optim.RMSprop(
            params=model.parameters(), lr=0.1, alpha=0.3, weight_decay=0.001)
        ...
        restored_model.load_state_dict(torch.load(
            os.path.join(folder_name, "weights.pt")))
