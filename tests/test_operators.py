...
from energize.evolution import Individual, operators
from energize.evolution.grammar import Genotype, Grammar, NonTerminal
...
class Test(unittest.TestCase):
    ...
    def assert_layers_mutation(self,
        ...
        for idx, l in zip(added_layers_idx, added_layers):
            expected_layers = expected_layers[:idx] + \
                [l] + expected_layers[idx:]
    ...
    def test_dsge_mutation(self):
        ...
        expected_sample.expansions[NonTerminal(name='value')][1] = [
