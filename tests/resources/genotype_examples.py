...
from energize.evolution.grammar import Attribute, Genotype, NonTerminal, Terminal
...
simple_sample1 = Genotype(
    expansions={
        ...
        NonTerminal(name='expr'): [
            [Terminal(name='(', attribute=None), NonTerminal(
                name='expr'), Terminal(name=')', attribute=None)],
            [Terminal(name='(', attribute=None), NonTerminal(
                name='expr'), Terminal(name=')', attribute=None)],
            [NonTerminal(name='expr'), NonTerminal(
                name='op'), NonTerminal(name='expr')],
            [Terminal(name='(', attribute=None), NonTerminal(
                name='expr'), Terminal(name=')', attribute=None)],
    ...
    expansions={
        NonTerminal(name='adam'): [
            [Terminal(name='learning:adam', attribute=None),
             Terminal(name='lr', attribute=Attribute(
                 "float", 1, 0.0001, 0.1, lambda x, y, z: [0.010994878808517258])),
             Terminal(name='beta1', attribute=Attribute(
                 "float", 1, 0.5, 0.9999, lambda x, y, z: [0.7755784963206666])),
             Terminal(name='beta2', attribute=Attribute(
                 "float", 1, 0.5, 0.9999, lambda x, y, z: [0.8532100487924581])),
        ...
        NonTerminal(name='early_stop'): [
            [Terminal(name='early_stop', attribute=Attribute(
                "int", 1, 10, 20, lambda x, y, z: [19]))]
        ],
        NonTerminal(name='learning'): [
            [NonTerminal(name='adam'),
             NonTerminal(name='early_stop'),
             Terminal(name='batch_size', attribute=Attribute(
                 "int_power2", 1, 5, 12, lambda x, y, z: [512])),
...
ind_test_macro1.expansions[NonTerminal(
    name='early_stop')][0][0].attribute.generate()
ind_test_macro1.expansions[NonTerminal(
    name='learning')][0][2].attribute.generate()
...
ind_test_macro2 = Genotype(
    expansions={
        NonTerminal(name='adam'): [
            [Terminal(name='learning:adam', attribute=None),
             Terminal(name='lr', attribute=Attribute(
                 "float", 1, 0.0001, 0.1, lambda x, y, z: [0.09265801171620802])),
             Terminal(name='beta1', attribute=Attribute(
                 "float", 1, 0.5, 0.9999, lambda x, y, z: [0.7080483514532836])),
             Terminal(name='beta2',
...
ind_test_macro2.expansions[NonTerminal(
    name='early_stop')][0][0].attribute.generate()
ind_test_macro2.expansions[NonTerminal(
    name='learning')][0][2].attribute.generate()
...
mutation_added_layer_genotype = Genotype(
    expansions={
        NonTerminal(name='padding'): [
            [Terminal(name='padding:valid', attribute=None)]
        ],
        ...
        NonTerminal(name='convolution'): [
            [
                Terminal(name='layer:conv', attribute=None),
                Terminal(name='out_channels', attribute=Attribute(var_type='int',
                                                                  num_values=1, min_value=32, max_value=256, generator=lambda x, y, z: [243])),
                Terminal(name='kernel_size', attribute=Attribute(var_type='int',
                                                                 num_values=1, min_value=2, max_value=5, generator=lambda x, y, z: [4])),
                Terminal(name='stride', attribute=Attribute(var_type='int',
                                                            num_values=1, min_value=1, max_value=3, generator=lambda x, y, z: [1])),
                NonTerminal(name='padding'),
                NonTerminal(name='activation_function'),
                NonTerminal(name='bias')
            ]
...
mutation_added_layer_genotype.expansions[NonTerminal(
    name='convolution')][0][1].attribute.generate()
mutation_added_layer_genotype.expansions[NonTerminal(
    name='convolution')][0][2].attribute.generate()
mutation_added_layer_genotype.expansions[NonTerminal(
    name='convolution')][0][3].attribute.generate()
